...
import zhawenting.electroniccontroller.config.ElectronicControllerApp;
...
public class CrashHandler implements Thread.UncaughtExceptionHandler {
    ...
    private ElectronicControllerApp app;
     ...
     * @throws
     */
    public void init(Context context,ElectronicControllerApp app) {
        // 传入app对象，为完美终止app
        this.app = app;
        mContext = context;
    ...
    private String saveCrashInfo2File(Throwable ex) {
        ...
        try {
            ...
            if (Environment.getExternalStorageState().equals(
                ...
                String path = Constants.DIR_PATH + "/crashs";
